...
This can take as many forms as [[physical system|physical systems]] you can think of. In one dimension, where $\mathbf{r}\to x$, we have many interesting examples.
#### Free particle
A [[free particle]] is
$$\ddot{x}=0$$
