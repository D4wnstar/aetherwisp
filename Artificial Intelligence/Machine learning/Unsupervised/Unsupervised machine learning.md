...
Unsupervised learning is useful to find patterns of the real system that produced the data, but the patterns are inherent to the [[dataset]] used to train the [[Artificial Intelligence/Machine learning/Model|model]]. They are not, in general, extensible to other datasets. As such, unsupervised techniques (and their models) are much less universal than supervised techniques.