...
Sebbene non sia un modo efficace di studiare l'universo, è possibile derivare le equazioni di Friedmann dalle [[leggi di Newton]]. È necessario tuttavia usare un risultato della relatività generale: il [[teorema di Birkhoff]], che è una generalizzazione [[Trasformazioni di Lorentz|relativistica]] del [[teorema di Gauss]]. In sostanza, dice che in una sfera di distribuzione di massa omogenea e isotropa, l'evoluzione all'interno della sfera non è influenzato da quella all'esterno della sfera.
### Seconda equazione
