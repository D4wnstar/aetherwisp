...
aliases:
  - fit
---
**Parameter estimation** is the statistical process which is used to find a set of parameters that make a mathematical relation **fit** a set of [[sample|sampled]] data. It is also called **fitting** (data to a model). The set of parameters is called a **[[Statistics/Modeling/Model|model]]**.
...
### Point estimation
Point estimation is the process of finding a reasonable parameter estimate for a model from given data.