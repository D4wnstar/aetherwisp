...
Alternatively, if $\sigma$ is known, it can be used instead of $S$. In that case, $T$ is usually called $Z$ and follows a [[Gaussian distribution|standard normal distribution]], $Z\sim \mathcal{N}(0,1)$:
