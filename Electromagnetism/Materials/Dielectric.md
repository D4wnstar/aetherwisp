...
[^1]: Actually, only the space where the field is nonzero needs to be like this. It makes no difference whether the susceptibility is constant or not if there is no field to speak of in the first place. If the field is created within the dielectric and becomes irrelevant before coming out of the surface, we might as well call all space homogeneous.