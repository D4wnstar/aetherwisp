...
#### Atoms
The simplest possible dielectric is a single atom, with a positively charged [[Atomic nucleus|atomic nucleus]] and a negatively charged [[Electron|electron]] cloud surrounding it. When subject to an [[electric field]], the nucleus and electron cloud move in opposite direction, as one is attracted by the field and the other is repelled. With a strong enough field, the electrons can be ripped from the nucleus, thus [[ionizzazione|ionizing]] the atom, but for milder fields, a state of equilibrium is reached.
