**Gauss' law** describes the flux of an [[electric field]] generated by a [[Electric charge|charge]] inside of a volume passing through the bounding [[Superficie|surface]] of that volume. Given a system of charges or a charge distribution within the enclosing surface $S$, the flux must be
