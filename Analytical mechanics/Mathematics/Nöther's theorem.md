...
> Let $H$ be a [[Hamiltonian]]. If $H$ is invariant under an infinitesimal [[canonical transformation]] generated by a generator $G(x)$, then $G(x)$ is a constant of motion (for the [[Hamilton equations|Hamilton equations]] of $H$).
### Proof
