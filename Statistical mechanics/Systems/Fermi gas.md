...
&=\frac{v}{\lambda_{T}^{3}}\left[ \frac{\lambda_{T} ^{3}}{v}+ \frac{1}{2^{3/2}} \left( \frac{\lambda_{T}^{3}}{v} \right)^{2}- \frac{1}{2^{5/2}}\left( \frac{\lambda ^{3}_{T}}{v} \right)^{2} +\ldots \right] \\
