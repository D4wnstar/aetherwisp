...
where $[\cdot,\cdot]$ is the [[Commutatore|commutator]] and $\hbar$ is the [[Planck constant|reduced Planck constant]]. This follows from the  [[Poisson bracket|Poisson bracket]] conversion $\{ \cdot,\cdot \}\to \frac{1}{i\hbar} [\cdot,\cdot]$.
### Examples
