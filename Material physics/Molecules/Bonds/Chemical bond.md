...
> Primary and secondary bonds are also called **strong** and **weak bonds**. Aetherwisp prefers the former terminology, even though the latter one is more common, just to avoid any accidental correlation with the [[Strong interaction|strong]] and [[Weak interaction|weak forces]], which can be seen as forming bonds of their own ([[Quark|quark confinement]] is in a way as a strong (interaction) bond, but not a strong (chemical) bond).
