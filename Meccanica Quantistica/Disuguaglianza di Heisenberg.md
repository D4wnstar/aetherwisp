...
In meccanica classica è possibile misurare, almeno in linea di principio, con infinita precisione. In meccanica quantistica, invece, si trova che gli errori su $\hat{p}$ e $\hat{q}$ sono
