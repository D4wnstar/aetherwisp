Si chiama **evolutore** l'[[operatore]] $\hat{U}_{t}$ definito come
...
con $\hat{P}$ il [[proiettore]]. L'evolutore rappresenta l'evoluzione temporale (*time evolution*) di un sistema quantistico. Esso risolve l'[[equazione di Schrödinger]]. Ci permette di trovare lo [[stato]] del sistema ad un tempo $t$ semplicemente applicandolo allo stato $|\psi\rangle$ iniziale
