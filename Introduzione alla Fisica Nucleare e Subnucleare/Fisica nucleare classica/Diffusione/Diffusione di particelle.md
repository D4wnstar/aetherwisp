...
La **diffusione anelastica** è un tipo di diffusione dove parte dell'energia cinetica viene trasferita dal proiettile $a$ al bersaglio $b$, che lo porta ad uno stato eccitato $b^{*}$. Questo poi [[Nuclear decay|decade]] allo stato fondamentale, emettendo una o più particelle.
