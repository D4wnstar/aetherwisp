...
Per esempio, l'attinio $^{226}Ac$ [[Alpha decay|decade]] $\alpha$ lo 0.006% delle volte, [[Beta decay|decade]] $\beta$ l'83% delle volte, subisce [[Beta decay|cattura elettronica]] il 17% delle volte. L'attinio ha tempo di dimezzamento $t_{1/2}=20$ ore. La costante di decadimento totale è $\lambda_{t}=0.693/t_{1/2}=6.6\times10^{-6}\text{ s}^{-1}$. Ricavo le costanti di decadimento parziali
$$\begin{align}
