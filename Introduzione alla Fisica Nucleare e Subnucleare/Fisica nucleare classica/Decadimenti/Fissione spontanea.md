...
wiki-publish: true
---
La **fissione spontanea** è un tipo di [[Nuclear decay|decadimento]] nel quale un [[Atomic nucleus|nucleo]] pesante (con $A$ grande) compie [[fissione nucleare]] spontaneamente, senza l'ausilio di [[Particle|particelle]] esterne.
...
ho un [[Q value]] di 181 MeV di energia. I due neutroni emessi hanno energia media $\left\langle E_{n} \right\rangle\sim2$ MeV, quindi a loro volta possono innescare fissione anche con alte energie. L'energia degli altri prodotti sono $E_{\beta}\sim19$ MeV, $E_{\gamma,\text{dec.}}\sim7$ MeV e $E_{\gamma,\text{pronto}}\sim8$ MeV.
